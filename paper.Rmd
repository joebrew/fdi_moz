...
author: "Trends, risks, and opportunities"
...
\begin{large}
Joe Brew\footnote{Barcelona Institute for Global Health; Vrije Universiteit Amsterdam} and Elisa Sicuri\footnote{Barcelona Institute for Global Health; Imperial College London}
\end{large}

\textbf{Abstract}
\end{center}

\emph{Foreign direct investment (FDI) in Mozambique has increased rapidly in the last two decades. The growing interest in corporate social responsibility (CSR) - combined with a recent push for malaria eradication - suggest the need for a critical examination of the research attention garnered by FDI and CSR, as well as how private firms spend money on  control. Through a systematic review of publications, we find that there has been a notable increase in research pertaining to FDI and CSR in recent years.  However, given the lack of coordination between public and private sectors, even when interests coincide, an over-reliance on foreign and private initiative for funding eradication is not without risks.}
...
This paper gives an overview of trends in FDI and CSR in Mozambique, with a focus on its impact on malaria control. It also offers a quasi-systematic review of the research attention garnered by FDI and CSR in recent years. It is by no means comprehensive, but offers a consolidated starting point for understanding both the place of FDI and CSR in the literature, as well as where the interests and incentives of the public and private sectors converge and differ in regards to malaria control.
...
# Charts etc. will eventually go here
```


In order to gauge research attention and focus on FDI and CSR insofar as they affect Mozambique and malaria, four systematic searches were carried out using the NCBI/pubmed databases:
...
The number of records retrieved for the 4 searches can be visualized over time below:

```{r}
barplot(1:10)
```

There are two important interpretations to the above plot. XXX YYY
