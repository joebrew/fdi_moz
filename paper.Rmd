...
\emph{Foreign direct investment in Mozambique has increased rapidly in the last two decades. The growing interest in corporate social responsibility suggests the need for a critical examination of how private firms spend money on public goods. The interests of both the private and public sectors suggest the need for more private investment in malaria control.  However, the latter is not without risks.}
...
In addition to the discovery of new resources, recent growth has also been fueled by political and economic reforms which have made it easier for foreigners to do business in Mozambique.  Of particular note, inflation has remained relatively low. 

```{r}
plot(jitter(1:10, 100),
     type = 'l',
        main = 'Inflation chart here')
```

The massive increases in FDI have also been facilitated by dramatic decreases in the costs to import and export, as well as the costs of starting a business and registering property.
...
Most of recent growth has come in the "extractive" industries, a term encompassing a range of industry, but in the Mozambican context largely applying to xxxxx.   
...
Growth has been concentrated in the capital region and in areas with extractive industries.
...
Corporate social responsibility in Mozambique is new in nomenclature, but activities which could be classified as CSR have existed since at least xxxxxx. The number of firms actively engaging in CSR cannot be ascertained (given the large and ever-changing number of small businesses), but virtually all of the largest firms, both foreign and domestic, have a CSR component.  

Examples of interest in CSR here.  \lipsum[1]

```{r}
barplot(jitter(1:10, 15),
        main = 'Chart from google trends about CSR')
```

Lots of examples of CSR go here.  \lipsum[1]

```{r}
plot(jitter(1:20, 20),
     type = 'l',
     main = 'Some chart about growing CSR activity')
```



### Malaria-related CSR (or lack thereof)

Most CSR-funded activities are focused on education, community development, women's rights and entrepreneurship. According to a UN poll, none of the country's largest firms invest directly in malaria-related CSR activities. [@Compact2007] This may be due to the perceived costs of malaria control, lack of perceived PR benefits, as well as the "opt-in" nature and privacy/legal issues generally related to engaging in health-related campaigns.   

That said, a majority of the firms interviewed by the UN indicated that one of the principal reasons for investment in CSR is to complement government efforts.  To the extent that malaria constitutes xxxx % of the burden of disease in Mozambique, malaria control's lack of representation among core CSR activities is a notable absence. 
...
The historical absence of malaria-related CSR represents an opportunity for complementarity. In addition the improvements in public health, both the private and public sectors stand to benefit economically from a scaling up of malaria control driven by the private sector. By increasing malaria control activities, as a share of total CSR expenditures, public funds could be redirected towards other areas of health, particularly the faltering xxx and yyy (which is not as suitable for CSR).  Likewise, CSR activities would have a more direct impact on wellbeing (with less temporal lag), thereby fulfilling the public relations goals of the firms that invest in CSR. Finally, for many industries, the firm itself is a potential direct beneficiary, given that improvements in employee health and a reduction in employee absenteeism can be directly correlated to productivity.  
...
A secondary risk is that in addition the financial divestment, increased private sector involvement in malaria control could cause a decrease in public sector _competence_ in the prevention and treatment of malaria. This could have negative consequences in the case of either a financial or economic crisis (in which CSR activity would be curtailed) or an increase in malarial activity. By the same token, CSR involvement in malaria control could potentially portend, at least initially, less effective malaria control. Private firms' incentives, though aligned with the public's in terms of malaria, are not identical, and pressures from shareholders and for positive public perception might motivate malaria control strategies which do not necessarily carry with them the most recent scientific knowledge.  
